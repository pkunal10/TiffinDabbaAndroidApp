package com.tiffin_dabba.admin.tiffindabba.Modals;

/**
 * Created by ADMIN on 06-10-2017.
 */

public class SimpleTiffins {
    ...
    public String getChawal() {
        return Chawal;
    }

    public void setChawal(String chawal) {
        Chawal = chawal;
    }
